...
public class AnimationUtils {
    ...
    public static void scaleY(View holder) {
        holder.setScaleY(0);

        PropertyValuesHolder propy = PropertyValuesHolder.ofFloat("scaleY", 1);

        ObjectAnimator animator = ObjectAnimator.ofPropertyValuesHolder(holder, propy);
...
//    }
    ...
    public static void animteTransalte(View holder, boolean goesDown){

            int holderHeight = holder.getHeight();
            holder.setPivotY(goesDown == true ? 0 : holderHeight);
           // AnimatorSet animatorSet = new AnimatorSet();
            ObjectAnimator animatorTranslateY = ObjectAnimator.ofFloat(holder, "translationY", goesDown == true ? 300 : -300, 0);
//            ObjectAnimator scaleY = ObjectAnimator.ofFloat(holder, "scaleY", 1f, 0.4f, 1f);
//            ObjectAnimator scaleX = ObjectAnimator.ofFloat(holder, "scaleX", 1f, 1.3f, 1f);
...
//            scaleX.setInterpolator(new OvershootInterpolator());
     ...
     * @param goesDown
     */
    public static void animate1(View holder, boolean goesDown) {
        int holderHeight = holder.getHeight();
        holder.setPivotY(goesDown == true ? 0 : holderHeight);
        AnimatorSet animatorSet = new AnimatorSet();
        ObjectAnimator animatorTranslateY = ObjectAnimator.ofFloat(holder, "translationY", goesDown == true ? 300 : -300, 0);
     ...
     * @param goesDown
     */
    public static void animateSunblind(View holder, boolean goesDown) {
        int holderHeight = holder.getHeight();
        holder.setPivotY(goesDown == true ? 0 : holderHeight);
        holder.setPivotX(holder.getHeight());
        AnimatorSet animatorSet = new AnimatorSet();
        ObjectAnimator animatorTranslateY = ObjectAnimator.ofFloat(holder, "translationY", goesDown == true ? 300 : -300, 0);
        ObjectAnimator animatorRotation = ObjectAnimator.ofFloat(holder, "rotationX", goesDown == true ? -90f : 90, 0f);
        ObjectAnimator animatorScaleX = ObjectAnimator.ofFloat(holder, "scaleX", 0.5f, 1f);
     ...
     * @param goesDown
     */
    public static void animateScatter(View holder, boolean goesDown) {
        counter = ++counter % 4;
        int holderHeight = holder.getHeight();
        int holderWidth = holder.getWidth();
        View holderItemView = holder;
